...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatBox = __webpack_require__(213);
	
	var _ChatBox2 = _interopRequireDefault(_ChatBox);
	
	var _MessageBox = __webpack_require__(214);
	...
	var _MainReducer = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../reducers/MainReducer\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var MainView = (function (_React$Component) {
		...
		function MainView(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(MainView).call(this, props));
		}
		...
		_createClass(Button, [{
			...
			value: function render() {
				...
				if (window.location.pathname !== "/") {
					var style = this.state.hover ? { backgroundColor: "#c9302c" } : {};
					link = _react2.default.createElement(
						_reactRouter.IndexLink,
						{ style: style, className: "btn btn-danger navbar-btn", to: "/", onMouseOver: this.mouseOver.bind(this), onMouseOut: this.mouseOut.bind(this) },
						"Go Back"
					);
				}
				return link;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LOGOUT = exports.LOGIN = exports.SIGN_UP = exports.SET_USERNAME = exports.RECEIVE_MESSAGE = exports.RECEIVE_MESSAGE_HISTORY = exports.SEND_MESSAGE = exports.SEND_LEAVE_INFO = exports.SEND_JOIN_INFO = exports.SETUP = undefined;
	exports.setup = setup;
	...
	var _Environment = __webpack_require__(212);
	...
	// action constants
	var SETUP = exports.SETUP = "setup";
	var SEND_JOIN_INFO = exports.SEND_JOIN_INFO = "send join";
	var SEND_LEAVE_INFO = exports.SEND_LEAVE_INFO = "send leave";
	...
	function fetchMessageHistory() {
		return function (dispatch) {
			(0, _isomorphicFetch2.default)(env.SERVER_FETCH_MESSAGE).then(function (res) {
				return res.json();
			}).then(function (json) {
				return dispatch(receiveMessageHistory(json));
			});
		};
	}
	...
	function requestLogin(username, password, router) {
		return function (dispatch) {
			var options = {
				method: "POST",
				headers: {
			...
			(0, _isomorphicFetch2.default)(env.SERVER_URL + "/login", options).then(function (res) {
				return res.json();
			}).then(function (json) {
				return dispatch(login(json, username, router));
			});
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatBox = (function (_React$Component) {
		...
		function ChatBox(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatBox).call(this, props));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ServerMessage = (function (_React$Component) {
		...
		function ServerMessage(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ServerMessage).call(this, props));
		}
	...
	var ChatMessage = (function (_React$Component2) {
		...
		function ChatMessage(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatMessage).call(this, props));
		}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"h1",
							{ className: "nrchat-form-separator" },
							"Login"
						),
						_react2.default.createElement(
							"form",
							...
							_react2.default.createElement(
								"div",
								{ className: "form-group nrchat-form-separator" },
								_react2.default.createElement(
									"label",
									{ htmlFor: "username" },
									"Username"
								),
								_react2.default.createElement("input", { type: "text", className: "form-control", name: "username", id: "username", placeholder: "Your name?" })
							),
							_react2.default.createElement(
								"div",
								{ className: "form-group nrchat-form-separator" },
								...
								_react2.default.createElement("input", { type: "password", className: "form-control", name: "password", id: "password", placeholder: "Shh it's a secret!" })
							),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", className: "form-control", name: "username", id: "username", placeholder: "Username should be at least 4 characters long." })
							),
							_react2.default.createElement(
								"div",
								{ className: "form-group nrchat-form-separator" },
								...
								_react2.default.createElement("input", { type: "password", className: "form-control", name: "password", id: "password", placeholder: "Password should be at least 4 characters long." })
							),
