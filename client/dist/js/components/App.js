...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainReducer = __webpack_require__(160);
	
	var _MainReducer2 = _interopRequireDefault(_MainReducer);
	
	var _NRChatReducer = __webpack_require__(170);
	
	var ChatAction = _interopRequireWildcard(_NRChatReducer);
	...
	var App = (function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function componentWillUnmount() {
				_MainReducer2.default.dispatch(ChatAction.disconnect());
			}
		}, {
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Dialog2.default, { id: "nameDialog" })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavBar = (function (_React$Component) {
		...
		function NavBar(props) {
			...
			_MainReducer2.default.subscribe(function () {
				_this.setState({
					username: _MainReducer2.default.getState().NRChatReducer.username
				});
			});
			return _this;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NRChatReducer = _interopRequireWildcard(_NRChatReducer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socket = __webpack_require__(171);
	...
	// action constants
	var ACTION_SETUP = "setup";
	var ACTION_SET_USERNAME = "set username";
	var ACTION_SEND_MESSAGE = "send message";
	var ACTION_DISCONNECT = "disconnect";
	var ACTION_FETCH_MESSAGES = "fetch messages";
	...
	// reducer
	function reducer() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? store : arguments[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hasBin = __webpack_require__(197);
	...
	var ChatBox = (function (_React$Component) {
		...
		_createClass(ChatBox, [{
			...
			value: function handleSend(e) {
				...
				if (message && message !== "") {
					_MainReducer2.default.dispatch(ChatAction.sendMessage(message));
					messageInput.value = "";
				}
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dialog = (function (_React$Component) {
		...
		_createClass(Dialog, [{
			...
			key: "handleConfrim",
			value: function handleConfrim(e) {
				var username = document.getElementById("usernameInput").value;
				if (username) {
					$("#" + this.props.id).modal("hide");
					_MainReducer2.default.dispatch(ChatAction.setUsername(username));
				}
			}
		}, {
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "modal fade", id: this.props.id, role: "dialog", "data-backdrop": "static", "data-keyboard": "false" },
					_react2.default.createElement(
						"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									"button",
									{ type: "button", className: "btn btn-primary", onClick: this.handleConfrim.bind(this) },
									"Confirm"
								)
							)
						)
